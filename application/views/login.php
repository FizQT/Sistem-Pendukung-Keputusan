...
<html lang="en">
    <head>
        ...
        <title>Sistem Pendukung Keputusan Metode ROC dan VIKOR</title>
    ...
    <body class="bg-gradient-warning">
        <nav class="navbar navbar-expand-lg navbar-warning bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <a class="navbar-brand text-warning" style="font-weight: 900;" href="<?= base_url('')?>"> <i class="fa fa-database mr-2 rotate-n-15"></i> Sistem Pendukung Keputusan Metode ROC dan VIKOR</a>
            </div>
        </nav>
				...
				<div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                    <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                        <div class="text-justify card-body p-0">
                            <h4 style="font-weight: 800;">Sistem Pendukung Keputusan Metode ROC dan VIKOR</h4>
                            <p class="pt-4">
                                Selamat datang di sistem kami! Diharapkan untuk Login terlebih dahulu!
                            </p>
                            <!-- <p class="pt-4">
